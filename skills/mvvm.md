...
> ⚠️ **REFERENCE ONLY — DO NOT USE FOR THIS PROJECT**
> This project uses **MVI** (BaseViewModel + sealed Intent/Effect). See `mvi.md` for the correct pattern.
> This file exists only as a reference for understanding MVVM concepts. Never apply MVVM patterns to this codebase.
